                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class=" collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                            <ul class="nav nav-stacked">
                                ...
                                <li><a href="#5" class="list-group-item">My Complain</a></li>
                ...
                <div class="col-md-9 " >
                    <div class="tab-content page1">
                        ...
                        <div id="1" class="tab-pane fade">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <%}%>
                                    <td style="color:green"><a href="ComplainDetails.htm?ref=<%= com.get(i).getComplainId() %>" data-toggle="modal" data-target=".bs-example-modal-lg">Details</a></td>
                        ...
                        <div id="5" class="tab-pane fade">
                            <div class=""><font color="red"><center> <h1>My complain</h1><center></font> </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <% ArrayList<ComplainTable> complains = loadComplain.getComplain();%>
                                <tr>
                                    <% for (int i = 0; i < complains.size(); i++) {%>
                                    <td><%= complains.get(i).getComplainId()%></td> 
                                    <td><%= complains.get(i).getUsername()%></td>
                                    <td><%= complains.get(i).getComplainTitle()%></td> 
                                    <td><%= complains.get(i).getVenue()%></td>
                                    <% if (complains.get(i).getStatus().equals("Pending")) {%>
                                    <td style="color: #c0a16b"><%= complains.get(i).getStatus()%></td> 
                                    <%} else {%>
                                    <td style="color:green"><%= complains.get(i).getStatus()%></td>
                                    <%}%>
                                     <td style="color:green"><a href="ComplainDetails.htm?ref=<%= com.get(i).getComplainId() %>" data-toggle="modal" data-target=".bs-example-modal-lg">Details</a></td>
                                     <td style="color:green"><a href="ApproveComplain.htm?ref=<%= com.get(i).getComplainId() %>">Approved</a></td>
                                </tr>
